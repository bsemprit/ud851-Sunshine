...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] fakeWeatherData = {
                "Saturday will be terrible sandstorms.",
                "Sunday same ole same ole",
                "Can't believe it's Monday and a sunny day!",
                "Look here comes Tuesday whoot! It's thundering",
                "Now it's Wednesday, windy swoosh!",
                "Oh no, Thursday it's thundering again!",
                "Finally, Friday fun day :)"
            };
