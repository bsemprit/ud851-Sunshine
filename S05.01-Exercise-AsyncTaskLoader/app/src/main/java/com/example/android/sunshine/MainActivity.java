...
// k (1) Implement the proper LoaderCallbacks interface and the methods of that interface
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    static final int LOADER_INT = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // k (7) Remove the code for the AsyncTask and initialize the AsyncTaskLoader
        /* Once all of our views are setup, we can load the weather data. */
    }


    // k (2) Within onCreateLoader, return a new AsyncTaskLoader that looks a lot like the existing FetchWeatherTask.
    ...
    // k (3) Cache the weather data in a member variable and deliver it in onStartLoading.

    // k (4) When the load is finished, show either the data or an error message if there is no data
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // k (5) Refactor the refresh functionality to work with our AsyncTaskLoader
        if (id == R.id.action_refresh) {
            mForecastAdapter.setWeatherData(null);
            getSupportLoaderManager().restartLoader(LOADER_INT, null, this);
            return true;
        }
