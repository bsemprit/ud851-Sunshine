...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData() {
        ...
        new FakeWeatherTask().execute(location);
    }

    // COMPLETED (5) Create a class that extends AsyncTask to perform network requests
    public class FakeWeatherTask extends AsyncTask<String, Void, String[]> {
        @Override
        protected String[] doInBackground(String... data) {
            String weatherData = data[0];

            URL weatherUrl = NetworkUtils.buildUrl(weatherData);
            try {
        ...
        protected void onPostExecute(String[] weather) {
            if(weather != null) {
                ...
                for(String weatherString : weather) {
