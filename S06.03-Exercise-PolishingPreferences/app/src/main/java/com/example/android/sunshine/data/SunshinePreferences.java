...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        // k (1) Return the user's preferred location
...
//        return getDefaultWeatherLocation();
    ...
    public static boolean isMetric(Context context) {
        // k (2) Return true if the user's preference for units is metric, false otherwise
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String units = context.getString(R.string.pref_units_key);
        String defaultUnits = context.getString(R.string.pref_units_metric);
        String unitPreference = sharedPreferences.getString(units, defaultUnits);
        if(unitPreference.equals(defaultUnits)) {
            return true;
        }
        return false;
    }
