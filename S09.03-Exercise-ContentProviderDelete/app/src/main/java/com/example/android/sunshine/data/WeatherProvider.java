...
//  k (1) Implement the delete method of the ContentProvider
    /**
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        return rowsDel;
//          k (2) Only implement the functionality, given the proper URI, to delete ALL rows in the weather table

//      k (3) Return the number of rows deleted
    }
