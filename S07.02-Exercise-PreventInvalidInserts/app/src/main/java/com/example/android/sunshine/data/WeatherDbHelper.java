...
//  k (2) Increment the database version after altering the behavior of the table
    /*
...
//              K (1) Append NOT NULL to each column's type declaration except for the _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // k (3) Within onUpgrade, drop the weather table if it exists
        sqLiteDatabase.delete(WeatherEntry.TABLE_NAME, "DROP TABLE IF EXISTS", null);
        onCreate(sqLiteDatabase);
        // k (4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
    }
}