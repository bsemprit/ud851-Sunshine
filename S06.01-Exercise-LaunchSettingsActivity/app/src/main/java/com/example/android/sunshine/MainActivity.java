...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // k (1) Add new Activity called SettingsActivity using Android Studio wizard
        // Do step 2 in SettingsActivity
        // k (2) Set setDisplayHomeAsUpEnabled to true on the support ActionBar

        // k (6) Launch SettingsActivity when the Settings option is clicked
